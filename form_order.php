...
if($_REQUEST['submit']){
	...
	if (!$link) {
		...
		echo "Прошло соединение к БД <br>";
	...
	$sql_order = "INSERT INTO orders (ContactId, City, Street, House, Flat) VALUES ('$contact_id', '".$_REQUEST['user_address_city']."', '".$_REQUEST['user_address_street']."', 
